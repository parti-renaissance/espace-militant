...
/** Sous-modale de confirmation de suppression : montée uniquement quand nécessaire, porte useDeleteMessage. */
function DeleteDraftConfirmModal({
  ...
  return (
    <ModalOrBottomSheet open onClose={onClose} allowDrag>
      <YStack
...
function QuitConfirmModalInner({ isOpen, onClose, onConfirm, messageId, scope }: QuitConfirmModalProps) {
  const media = useMedia()
  ...
  return (
    <>
      ...
      {showDeleteConfirm && messageId && scope ? (
...
const QuitConfirmModal = memo(QuitConfirmModalInner)

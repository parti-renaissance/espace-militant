      ...
      <ModalOrBottomSheet open={isOpen} onClose={onClose} allowDrag>
        ...
        >
          <YStack gap="$medium" alignItems="center">
            ...
            <Text textAlign="center" color="$blue5" fontSize={32}>
          ...
          <YStack gap={media.sm ? '$xxxlarge' : '$large'} alignItems="center" justifyContent="center">
            <VoxButton theme="orange" variant="outlined" iconLeft={Trash2} onPress={handleDeleteDraft} disabled={deleteMessage.isPending} alignSelf="center">
              {deleteMessage.isPending ? 'Suppression...' : 'Supprimer ce brouillon'}
            </VoxButton>
            <VoxButton theme="blue" onPress={onConfirm} alignSelf="center">
              Quitter l'édition
            </VoxButton>
          </YStack>
        </YStack>
      ...
      <ModalOrBottomSheet open={showDeleteConfirm} onClose={() => setShowDeleteConfirm(false)} allowDrag>
        ...
        >
          <YStack gap="$medium" alignItems="center">
            ...
            <Text.MD textAlign="center">Êtes-vous sûr de vouloir supprimer définitivement ce brouillon ? Cette action est irréversible.</Text.MD>
          </YStack>

          <XStack gap="$medium" alignItems="center" justifyContent="center">
            <VoxButton theme="gray" variant="outlined" onPress={() => setShowDeleteConfirm(false)} alignSelf="center">
              Annuler
            </VoxButton>
            <VoxButton theme="orange" onPress={confirmDelete} disabled={deleteMessage.isPending} alignSelf="center">

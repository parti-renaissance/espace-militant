...
export const AttachmentRenderer = ({
  ...
  const {
    containerStyle,
    wrapperStyle: { paddingTop, paddingBottom, ...wrapperStyle },
  ...
  return (
    ...
    >
      <XStack style={containerStyle} gap={10} alignItems="center" justifyContent="center" onPress={handlePress} cursor="pointer">

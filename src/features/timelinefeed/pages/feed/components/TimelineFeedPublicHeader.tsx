...
type TimelineFeedPublicHeaderProps = {
  alerts: RestAlertsResponse
}

export function TimelineFeedPublicHeader({ alerts }: TimelineFeedPublicHeaderProps) {
  ...
  const hasContentAboveTitle = hasLiveAlerts || hasAlerts

...
import DeleteModal from '@/features/publications/components/DeleteModal'
...
function PublicationsContent({ scope, accessDenyButton }: { scope: string; accessDenyButton?: React.ReactNode }) {
  ...
  const listEmptyComponent = useMemo(() => {
    ...
    if (error instanceof UnauthorizedError || error instanceof ForbiddenError) {
      return <AccessDeny message="Votre rôle cadre actif ne vous permet pas d'accéder à cette fonctionnalité." Button={accessDenyButton} />
    }
  ...
  return (
    <>
      ...
      <DeleteModal isOpen={deleteMessageId !== null} onClose={handleCloseDeleteModal} messageId={deleteMessageId} scope={scope} />
    </>
  )
}
...
export default function PublicationsScreen() {
  ...
  return <PublicationsContent scope={defaultScope} accessDenyButton={accessDenyButton} />
}

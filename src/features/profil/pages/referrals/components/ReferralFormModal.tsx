...
export default function ReferralFormModal({ isOpen, closeModal }: Props) {
  ...
  const { mutate: invite, isPending: isInviting, isSuccess: isInviteSuccess, reset: resetInviteState } = useReferralsInvite()
  const { mutate: preRegister, isPending: isRegistering, isSuccess: isPreRegisterSuccess, reset: resetPreRegisterState } = useReferralsPreRegister()

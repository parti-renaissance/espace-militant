...
const PhoningSessionLoaderScreen = () => {
    ...
    const handleSession = useCallback(() => {
            switch (device) {
                ...
                default:
                    router.replace({
                        pathname: '/old/actions/phoning/session/[device]/number-found',
                        params: { device }
                    })
                    break
                case 'external':
                    router.replace({
                        pathname: '/old/actions/phoning/session/[device]/number-found-other-device',
                        params: { device }
                    })
                    break
            }
        ...
        PhoningCampaignRepository.getInstance()
            ...
            .catch((error) => {
                if (
                    ...
                    router.replace({
                        pathname: '/old/actions/phoning/session/[device]/no-number-available',
